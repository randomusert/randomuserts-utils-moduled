...
## Developers
This mod has a public API/ Core Module..
...
````groovy
depedencies {
    implementation "io.github.randomusert.mods.randomuserts_utils:randomuserts-utils-core:${rstsUtils_version}"
}
````
...
````java
import io.github.randomusert.mods.randomuserts_utils.api;
````
